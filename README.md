...
- [nixCat](#nixcat-config)
  - [1. Mason Compatibility Issues](#1-mason-compatibility-issues)
  - [2. LSP and Completion Issues](#2-lsp-and-completion-issues)
  - [3. LazyVim as a "Second-Class Citizen" in Nix](#3-lazyvim-as-a-second-class-citizen-in-nix)
